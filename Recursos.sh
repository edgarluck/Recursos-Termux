...
echo -e "$magenta
   ++++++++++++++++$verde
   Elige una opcion:$magenta
   ++++++++++++++++

         $verde[${blanco}01$verde]$blanco Recursos Termux

	 $verde[${blanco}02$verde]$blanco Contactame
...
"
echo -e "
$verde[$blanco*$verde]$blanco Actualizando....
"
sleep 2.5
apt update -y
echo -e "
...
sleep 2
echo -e "
$verde[$blanco*$verde]$blanco Descargando....
            "${blanco}
sleep 2
pkg install wget -y
echo -e ${magenta}"   +++++++++++++++++++++++++++++++++++"
